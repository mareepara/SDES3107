...
void setup() {
  ...
  smooth();
  cursor(CROSS);
  println("collage of Images");
     PImage img = loadImage("driving-through-cactus-fore.jpg");
   image(img, 0, 0, width, height);
   
      tint (255,50);   
  PImage img2 = loadImage ("sugar_skull.png");
...
//Collage of added images changed colour of text 
